...
import { register, login, googleLogin, getMe, becomeOwner, updateProfile, logout, changePassword, forgotPassword, resetPassword } from '../controllers/authController.js';
